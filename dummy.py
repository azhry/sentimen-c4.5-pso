...
pso_c45_scores_2 = np.array([51.04, 53.12, 54.74, 45.26, 44.21, 50.03, 48.42, 44.21, 51.58, 48.42])
...
plt.ylabel("Akurasi")
plt.yticks(y_axis)
plt.title(f"Hasil Perbandingan Akurasi C4.5 dan PSO - C4.5 Konfigurasi 3 (+{round(result_mean_3, 2)}%)")
plt.show()